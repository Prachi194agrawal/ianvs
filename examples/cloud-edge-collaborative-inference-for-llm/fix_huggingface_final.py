...
# Complete, robust HuggingfaceLLM class
# Includes tokenizer loading AND all config attributes
new_class_start = """
class HuggingfaceLLM(BaseLLM):
    def __init__(self, **kwargs):
        ...
        # [FIX] Initialize generation parameters
...
if match:
    ...
    # Find start of _infer method (we keep _infer, we replace __init__ and _load_model)
    ...
    if infer_match:
        ...
        with open(file_path, 'w') as f:
            f.write(new_content)
        print("SUCCESS: HuggingfaceLLM patched with missing attributes.")
    else:
        print("WARNING: Could not find _infer method.")
else:
